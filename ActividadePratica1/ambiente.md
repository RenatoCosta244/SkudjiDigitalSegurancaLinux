...
Virtual machine, maquina virtual Linux 26. na minha maquina local

## Tipo de ambiente
VM local
Maquina virtual Linux ubunto

## Sistema utilizado
Maquina virtual Linux ubunto 26.04-live-server-64

## Recursos desponivel 
CPU->
    Arquitetura : x86-64
      CPU op-mode:32-bit, 64-bit
      Adress size:39 bits physical, 48 bit virtual
      CPU 1
RAM->
              Total   Used   Free   Shared
 Mem:         3.7Gi   443Mi  2.9Gi  1.1Mi 
 Swap:          0B      0B     0B

DISCO->
      Filesystem        Size   Used    Availe   Use%  Mounted on 
       tmpsf            748M   1.1M    747M       1%    /run
       none             1.0M     0M    1.0M       0%    /run
    /div/mapper/ubunto  9.8G   3.0G    6.4G      32%    
